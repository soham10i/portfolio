...
import { loadMazeEngine } from '@/features/factory-twin/lib/twin';
...
export interface SimState {
  ...
  blue: boolean;
  yellow: boolean;
  /** Set when the world's exported spawn was sealed and had to be moved. */
  spawnMoved?: { from: [number, number]; to: [number, number]; by: number } | { sealed: true } | null;
}
